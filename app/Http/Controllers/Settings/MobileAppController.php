...
class MobileAppController extends Controller
{
    ...
    {
        $configuredServerUrl = $this->normalizeServerUrl((string) config('services.mobile_app.server_url'));
        $serverIp = $configuredServerUrl !== '' ? $configuredServerUrl : $this->resolveRequestServer($request);
    ...
    private function resolveRequestServer(Request $request): string
    {
        ...
        return $port ? $hostIp.':'.$port : $hostIp;
    }
